//Dựng (các) cây DUYỆT ĐỒ THỊ khi duyệt đồ thị theo chiều rộng bắt đầu từ đỉnh 1. (đồ thị vô hướng đơn)
...
//        mark[u] = 1;
        ...
        for (int v = 1; v <= pG->n; v++){
            if (pG->A[u][v] > 0 && mark[v] == 0){   //thêm mark[v] == 0 để tránh enqueue 1 đỉnh nhiều lần
                enqueue(&Q, v);
                parent[v] = u;
                mark[v] = 1;
            }
